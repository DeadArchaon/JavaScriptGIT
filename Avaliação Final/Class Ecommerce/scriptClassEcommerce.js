...
const product1 = { id: 1, name: 'Batatas', price: 69 };
const product2 = { id: 2, name: 'Arroz', price: 666 };
...
ecommerce.addProduct({ id:3, name: 'Feijão', price: 999});
...
console.log(ecommerce.getProductByName('Batatas'));
